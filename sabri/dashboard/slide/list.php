      ...
      <div class='modal-body'>
       <img src='".URL."img/slide/$row[gambar_slide]' class='img-fluid'>
		          				...
		          				<td class='text-center'>
	                                 ...
	                                 <a class='btn btn-outline-primary btn-sm' href='".URL."dashboard/dashboard.php?menu=slide&action=form&slide_id=$row[slide_id]' role='button'><img src='".URL."img/edit.png' class='rounded' style='width:20px;height:20px;'></a>
	                                </p>

	                                <p class='d-inline-flex'>
	                                 <a class='btn btn-outline-primary btn-sm' href='".URL."dashboard/slide/action.php?button=delete&slide_id=$row[slide_id]' role='button'><img src='".URL."img/delete.jpg' class='rounded' style='width:20px;height:20px;'></a>
	                                </p>
